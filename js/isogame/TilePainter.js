...
dojo.provide( 'isogame.TilePainter' );
dojo.declare( 'isogame.TilePainter', null, {
	...
	_drawTileIdx:function( Yi, Xi, x, y )
	{
		...
		isogame.TilePainter.drawNumber( this.info, Yi, x+this.bytes.th-5, y+this.bytes.thh-3);
...
isogame.TilePainter.drawNumber = function( bd, nr, x, y ){
	var i;
	switch( nr )
	{
		case 0:
